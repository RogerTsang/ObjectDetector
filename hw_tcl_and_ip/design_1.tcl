...
proc create_root_design { parentCell } {
  ...
  set EdgeDetect_Top_0 [ create_bd_cell -type ip -vlnv skin_detect:hls:EdgeDetect_Top:1.0 EdgeDetect_Top_0 ]
...
CONFIG.C_SLOT_1_INTF_TYPE {xilinx.com:interface:axis_rtl:1.0} \
  ...
  connect_bd_intf_net -intf_net ImgProcess_Top_0_OUTPUT_STREAM [get_bd_intf_pins EdgeDetect_Top_0/OUTPUT_STREAM] [get_bd_intf_pins axi_vdma_0/S_AXIS_S2MM]
connect_bd_intf_net -intf_net [get_bd_intf_nets ImgProcess_Top_0_OUTPUT_STREAM] [get_bd_intf_pins EdgeDetect_Top_0/OUTPUT_STREAM] [get_bd_intf_pins system_ila/SLOT_1_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets ImgProcess_Top_0_OUTPUT_STREAM]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_vdma_0_M_AXIS_MM2S] [get_bd_intf_pins EdgeDetect_Top_0/INPUT_STREAM] [get_bd_intf_pins system_ila/SLOT_0_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins EdgeDetect_Top_0/s_axi_CONTROL_BUS] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins EdgeDetect_Top_0/ap_clk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_ila/clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins EdgeDetect_Top_0/ap_rst_n] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_vdma_0/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_processing_system7_0_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_vdma_0/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_processing_system7_0_ACP_DDR_LOWOCM
  ...
  create_bd_addr_seg -range 0x00400000 -offset 0xE0000000 [get_bd_addr_spaces axi_vdma_0/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_IOP] SEG_processing_system7_0_ACP_IOP
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs EdgeDetect_Top_0/s_axi_CONTROL_BUS/Reg] SEG_EdgeDetect_Top_0_Reg
...
preplace inst EdgeDetect_Top_0 -pg 1 -lvl 1 -y 120 -defaultsOSRD
preplace inst axi_vdma_0 -pg 1 -lvl 2 -y 270 -defaultsOSRD
preplace inst system_ila -pg 1 -lvl 4 -y 80 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 5 -y 160 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 4 -y 460 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 5 -y 480 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 3 -y 390 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 3 3 1210J 320 NJ 320 1890J
preplace netloc ImgProcess_Top_0_OUTPUT_STREAM 1 1 3 430 110 NJ 110 1210
preplace netloc axi_vdma_0_M_AXI_MM2S 1 2 3 NJ 210 NJ 210 1590
preplace netloc processing_system7_0_M_AXI_GP0 1 3 2 NJ 370 1570
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 0 5 30 570 440 570 NJ 570 NJ 570 1620
preplace netloc axi_vdma_0_M_AXIS_MM2S 1 0 4 30 40 NJ 40 810 40 1210J
preplace netloc processing_system7_0_FCLK_RESET0_N 1 3 1 1240
preplace netloc axi_mem_intercon_M00_AXI 1 2 4 810 520 1230J 310 NJ 310 1880
preplace netloc ps7_0_axi_periph_M01_AXI 1 0 6 20 10 NJ 10 NJ 10 NJ 10 NJ 10 1890
preplace netloc processing_system7_0_FIXED_IO 1 3 3 NJ 330 NJ 330 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 5 20 550 430 550 800 550 1220 550 1600
preplace netloc axi_vdma_0_M_AXI_S2MM 1 2 3 NJ 230 NJ 230 1580
preplace netloc ps7_0_axi_periph_M00_AXI 1 1 5 440 150 NJ 150 NJ 150 1560J 20 1880
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 4 1 1610
levelinfo -pg 1 0 240 640 1020 1400 1750 1910 -top 0 -bot 620
",
}
