...
module EdgeDetect_Top_AXIvideo2Mat112 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] exitcond4_i_i_i_fu_331_p2;
reg    ap_sig_cseq_ST_st4_fsm_3;
reg    ap_sig_bdd_126;
wire   [7:0] i_V_fu_336_p2;
reg   [7:0] i_V_reg_428;
wire   [0:0] exitcond5_i_i_i_fu_342_p2;
reg   [0:0] exitcond5_i_i_i_reg_433;
...
always @ (posedge ap_clk) begin : ap_ret_ap_done_reg
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_const_logic_1 == ap_continue)) begin
            ap_done_reg <= ap_const_logic_0;
        end else if (((ap_const_logic_1 == ap_sig_cseq_ST_st4_fsm_3) & ~(exitcond4_i_i_i_fu_331_p2 == ap_const_lv1_0))) begin
...
always @ (posedge ap_clk) begin : ap_ret_ap_reg_ppiten_pp1_it0
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_const_logic_1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & ~(ap_sig_bdd_156 & (ap_const_logic_1 == ap_reg_ppiten_pp1_it1)) & ~(exitcond5_i_i_i_fu_342_p2 == ap_const_lv1_0))) begin
            ap_reg_ppiten_pp1_it0 <= ap_const_logic_0;
        end else if (((ap_const_logic_1 == ap_sig_cseq_ST_st4_fsm_3) & (exitcond4_i_i_i_fu_331_p2 == ap_const_lv1_0))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (exitcond5_i_i_i_reg_433 == ap_const_lv1_0) & (ap_const_logic_1 == ap_reg_ppiten_pp1_it1) & ~(ap_sig_bdd_156 & (ap_const_logic_1 == ap_reg_ppiten_pp1_it1)))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (ap_const_logic_1 == ap_reg_ppiten_pp1_it1) & ~(ap_sig_bdd_156 & (ap_const_logic_1 == ap_reg_ppiten_pp1_it1)) & ~(exitcond5_i_i_i_reg_433 == ap_const_lv1_0))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (ap_const_logic_1 == ap_reg_ppiten_pp1_it0) & ~(ap_sig_bdd_156 & (ap_const_logic_1 == ap_reg_ppiten_pp1_it1)) & (exitcond5_i_i_i_fu_342_p2 == ap_const_lv1_0))) begin
        p_4_i_i_i_reg_208 <= j_V_fu_347_p2;
    end else if (((ap_const_logic_1 == ap_sig_cseq_ST_st4_fsm_3) & (exitcond4_i_i_i_fu_331_p2 == ap_const_lv1_0))) begin
        p_4_i_i_i_reg_208 <= ap_const_lv8_0;
    end
end

always @ (posedge ap_clk) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st3_fsm_2)) begin
        p_i_i_i_reg_197 <= ap_const_lv8_0;
    end else if ((ap_const_logic_1 == ap_sig_cseq_ST_st8_fsm_6)) begin
...
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & ~(ap_sig_bdd_156 & (ap_const_logic_1 == ap_reg_ppiten_pp1_it1)))) begin
        exitcond5_i_i_i_reg_433 <= exitcond5_i_i_i_fu_342_p2;
    end
end
...
always @ (ap_done_reg or exitcond4_i_i_i_fu_331_p2 or ap_sig_cseq_ST_st4_fsm_3) begin
    if (((ap_const_logic_1 == ap_done_reg) | ((ap_const_logic_1 == ap_sig_cseq_ST_st4_fsm_3) & ~(exitcond4_i_i_i_fu_331_p2 == ap_const_lv1_0)))) begin
...
always @ (exitcond4_i_i_i_fu_331_p2 or ap_sig_cseq_ST_st4_fsm_3) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st4_fsm_3) & ~(exitcond4_i_i_i_fu_331_p2 == ap_const_lv1_0))) begin
...
always @ (ap_sig_cseq_ST_st2_fsm_1 or input_V_id_V0_status or exitcond5_i_i_i_reg_433 or ap_sig_cseq_ST_pp1_stg0_fsm_4 or brmerge_i_i_i_fu_356_p2 or ap_sig_bdd_156 or ap_reg_ppiten_pp1_it1 or ap_sig_cseq_ST_st7_fsm_5 or ap_sig_bdd_177 or eol_2_i_i_i_reg_302) begin
    if ((((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1) & ~(input_V_id_V0_status == ap_const_logic_0)) | ((ap_const_logic_1 == ap_sig_cseq_ST_st7_fsm_5) & (ap_const_lv1_0 == eol_2_i_i_i_reg_302) & ~ap_sig_bdd_177) | ((ap_const_logic_1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (exitcond5_i_i_i_reg_433 == ap_const_lv1_0) & (ap_const_lv1_0 == brmerge_i_i_i_fu_356_p2) & (ap_const_logic_1 == ap_reg_ppiten_pp1_it1) & ~(ap_sig_bdd_156 & (ap_const_logic_1 == ap_reg_ppiten_pp1_it1))))) begin
...
always @ (exitcond5_i_i_i_reg_433 or ap_sig_cseq_ST_pp1_stg0_fsm_4 or ap_sig_bdd_156 or ap_reg_ppiten_pp1_it1) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (exitcond5_i_i_i_reg_433 == ap_const_lv1_0) & (ap_const_logic_1 == ap_reg_ppiten_pp1_it1) & ~(ap_sig_bdd_156 & (ap_const_logic_1 == ap_reg_ppiten_pp1_it1)))) begin
...
always @ (ap_CS_fsm or ap_sig_bdd_99 or input_V_id_V0_status or exitcond4_i_i_i_fu_331_p2 or ap_sig_cseq_ST_pp1_stg0_fsm_4 or ap_reg_ppiten_pp1_it0 or ap_sig_bdd_156 or ap_reg_ppiten_pp1_it1 or ap_sig_bdd_177 or eol_2_i_i_i_reg_302 or tmp_user_V_fu_322_p1) begin
    case (ap_CS_fsm)
        ap_ST_st1_fsm_0 : 
        begin
        ...
        ap_ST_st4_fsm_3 : 
        begin
            if (~(exitcond4_i_i_i_fu_331_p2 == ap_const_lv1_0)) begin
                ap_NS_fsm = ap_ST_st1_fsm_0;
            end else begin
...
always @ (src_mat_data_stream_0_V_full_n or src_mat_data_stream_1_V_full_n or src_mat_data_stream_2_V_full_n or input_V_id_V0_status or exitcond5_i_i_i_reg_433 or brmerge_i_i_i_fu_356_p2) begin
    ap_sig_bdd_156 = (((input_V_id_V0_status == ap_const_logic_0) & (exitcond5_i_i_i_reg_433 == ap_const_lv1_0) & (ap_const_lv1_0 == brmerge_i_i_i_fu_356_p2)) | ((exitcond5_i_i_i_reg_433 == ap_const_lv1_0) & (src_mat_data_stream_0_V_full_n == ap_const_logic_0)) | ((exitcond5_i_i_i_reg_433 == ap_const_lv1_0) & (src_mat_data_stream_1_V_full_n == ap_const_logic_0)) | ((exitcond5_i_i_i_reg_433 == ap_const_lv1_0) & (src_mat_data_stream_2_V_full_n == ap_const_logic_0)));
end
...
always @ (exitcond5_i_i_i_reg_433 or ap_sig_cseq_ST_pp1_stg0_fsm_4 or ap_reg_ppiten_pp1_it1) begin
    ap_sig_bdd_257 = ((ap_const_logic_1 == ap_sig_cseq_ST_pp1_stg0_fsm_4) & (exitcond5_i_i_i_reg_433 == ap_const_lv1_0) & (ap_const_logic_1 == ap_reg_ppiten_pp1_it1));
end
...
assign exitcond4_i_i_i_fu_331_p2 = (p_i_i_i_reg_197 == rows? 1'b1: 1'b0);

assign exitcond5_i_i_i_fu_342_p2 = (p_4_i_i_i_reg_208 == cols? 1'b1: 1'b0);

assign i_V_fu_336_p2 = (p_i_i_i_reg_197 + ap_const_lv8_1);
...
assign j_V_fu_347_p2 = (p_4_i_i_i_reg_208 + ap_const_lv8_1);
...
endmodule //EdgeDetect_Top_AXIvideo2Mat112
