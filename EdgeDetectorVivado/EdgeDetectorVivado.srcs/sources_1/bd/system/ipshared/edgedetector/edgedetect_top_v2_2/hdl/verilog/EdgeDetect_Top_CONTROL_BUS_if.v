...
`timescale 1ns/1ps
module EdgeDetect_Top_CONTROL_BUS_if
#(parameter
    C_ADDR_WIDTH = 6,
    C_DATA_WIDTH = 32
)(
...
localparam
    ...
    ADDR_THREASHOLD_CTRL   = 6'h20,
    ADDR_THREASHOLD_DATA_0 = 6'h24;
...
always @(posedge ACLK) begin
    if (ar_hs) begin
        ...
        case (raddr)
            ...
            ADDR_THREASHOLD_DATA_0: begin
                rdata <= _threashold[31:0];
            end
        endcase
    end
end
...
assign I_rows       = _rows;
assign I_cols       = _cols;
assign I_threashold = _threashold;
...
// _threashold[31:0]
always @(posedge ACLK) begin
    if (w_hs && waddr == ADDR_THREASHOLD_DATA_0)
        _threashold[31:0] <= (WDATA[31:0] & wmask) | (_threashold[31:0] & ~wmask);
end
