...
module EdgeDetect_Top_Mat2AXIvideo_24_256_256_32_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_sig_bdd_23;
reg   [8:0] p_1_i_reg_170;
reg    ap_sig_bdd_79;
wire   [8:0] r_V_fu_181_p2;
wire   [0:0] exitcond5_i_fu_192_p2;
reg    ap_sig_cseq_ST_st2_fsm_1;
reg    ap_sig_bdd_93;
wire   [8:0] i_V_fu_197_p2;
reg   [8:0] i_V_reg_265;
wire   [0:0] exitcond6_i_fu_203_p2;
reg   [0:0] exitcond6_i_reg_270;
...
always @ (posedge ap_clk) begin : ap_ret_ap_done_reg
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_const_logic_1 == ap_continue)) begin
            ap_done_reg <= ap_const_logic_0;
        end else if (((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1) & ~(exitcond5_i_fu_192_p2 == ap_const_lv1_0))) begin
...
always @ (posedge ap_clk) begin : ap_ret_ap_reg_ppiten_pp0_it0
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & ~(ap_sig_bdd_122 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1)) & ~(exitcond6_i_fu_203_p2 == ap_const_lv1_0))) begin
            ap_reg_ppiten_pp0_it0 <= ap_const_logic_0;
        end else if (((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1) & (exitcond5_i_fu_192_p2 == ap_const_lv1_0))) begin
...
always @ (posedge ap_clk) begin : ap_ret_ap_reg_ppiten_pp0_it1
    if (ap_rst == 1'b1) begin
        ...
        end else if ((((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1) & (exitcond5_i_fu_192_p2 == ap_const_lv1_0)) | ((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & ~(ap_sig_bdd_122 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1)) & ~(exitcond6_i_fu_203_p2 == ap_const_lv1_0)))) begin
            ap_reg_ppiten_pp0_it1 <= ap_const_logic_0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & (ap_const_logic_1 == ap_reg_ppiten_pp0_it0) & ~(ap_sig_bdd_122 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1)) & (exitcond6_i_fu_203_p2 == ap_const_lv1_0))) begin
        p_1_i_reg_170 <= j_V_fu_208_p2;
    end else if (((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1) & (exitcond5_i_fu_192_p2 == ap_const_lv1_0))) begin
        p_1_i_reg_170 <= ap_const_lv9_0;
    end
end
...
always @ (posedge ap_clk) begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st5_fsm_3)) begin
        ...
        p_i_reg_159 <= ap_const_lv9_0;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & (exitcond6_i_reg_270 == ap_const_lv1_0) & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1) & ~(ap_sig_bdd_122 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1)))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & ~(ap_sig_bdd_122 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1)))) begin
        exitcond6_i_reg_270 <= exitcond6_i_fu_203_p2;
    end
end
...
always @ (exitcond6_i_reg_270 or ap_sig_cseq_ST_pp0_stg0_fsm_2 or ap_sig_bdd_122 or ap_reg_ppiten_pp0_it1) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_pp0_stg0_fsm_2) & (exitcond6_i_reg_270 == ap_const_lv1_0) & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1) & ~(ap_sig_bdd_122 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1)))) begin
...
always @ (ap_done_reg or exitcond5_i_fu_192_p2 or ap_sig_cseq_ST_st2_fsm_1) begin
    if (((ap_const_logic_1 == ap_done_reg) | ((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1) & ~(exitcond5_i_fu_192_p2 == ap_const_lv1_0)))) begin
...
always @ (exitcond5_i_fu_192_p2 or ap_sig_cseq_ST_st2_fsm_1) begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st2_fsm_1) & ~(exitcond5_i_fu_192_p2 == ap_const_lv1_0))) begin
...
always @ (ap_CS_fsm or ap_sig_bdd_79 or exitcond5_i_fu_192_p2 or exitcond6_i_fu_203_p2 or ap_reg_ppiten_pp0_it0 or ap_sig_bdd_122 or ap_reg_ppiten_pp0_it1) begin
    case (ap_CS_fsm)
        ap_ST_st1_fsm_0 : 
        begin
        ...
        ap_ST_st2_fsm_1 : 
        begin
            if (~(exitcond5_i_fu_192_p2 == ap_const_lv1_0)) begin
                ap_NS_fsm = ap_ST_st1_fsm_0;
            end else begin
        ...
        begin
            if (~((ap_const_logic_1 == ap_reg_ppiten_pp0_it0) & ~(ap_sig_bdd_122 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1)) & ~(exitcond6_i_fu_203_p2 == ap_const_lv1_0))) begin
                ap_NS_fsm = ap_ST_pp0_stg0_fsm_2;
            end else if (((ap_const_logic_1 == ap_reg_ppiten_pp0_it0) & ~(ap_sig_bdd_122 & (ap_const_logic_1 == ap_reg_ppiten_pp0_it1)) & ~(exitcond6_i_fu_203_p2 == ap_const_lv1_0))) begin
...
always @ (img_data_stream_0_V_empty_n or img_data_stream_1_V_empty_n or img_data_stream_2_V_empty_n or exitcond6_i_reg_270 or AXI_video_strm_V_id_V1_status) begin
    ap_sig_bdd_122 = (((img_data_stream_0_V_empty_n == ap_const_logic_0) & (exitcond6_i_reg_270 == ap_const_lv1_0)) | ((exitcond6_i_reg_270 == ap_const_lv1_0) & (img_data_stream_1_V_empty_n == ap_const_logic_0)) | ((exitcond6_i_reg_270 == ap_const_lv1_0) & (img_data_stream_2_V_empty_n == ap_const_logic_0)) | ((exitcond6_i_reg_270 == ap_const_lv1_0) & (AXI_video_strm_V_id_V1_status == ap_const_logic_0)));
end
...
assign exitcond5_i_fu_192_p2 = (p_i_reg_159 == rows? 1'b1: 1'b0);

assign exitcond6_i_fu_203_p2 = (p_1_i_reg_170 == cols? 1'b1: 1'b0);

assign i_V_fu_197_p2 = (p_i_reg_159 + ap_const_lv9_1);

assign j_V_fu_208_p2 = (p_1_i_reg_170 + ap_const_lv9_1);

assign r_V_fu_181_p2 = ($signed(cols) + $signed(ap_const_lv9_1FF));


endmodule //EdgeDetect_Top_Mat2AXIvideo_24_256_256_32_s
