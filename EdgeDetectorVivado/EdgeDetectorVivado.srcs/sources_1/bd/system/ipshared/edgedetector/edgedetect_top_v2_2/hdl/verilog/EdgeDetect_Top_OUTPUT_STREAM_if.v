...
module EdgeDetect_Top_OUTPUT_STREAM_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    output wire        TVALID,
...
//------------------------Instantiation------------------
// rs
EdgeDetect_Top_OUTPUT_STREAM_reg_slice #(
    .N       ( 34 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
EdgeDetect_Top_OUTPUT_STREAM_fifo #(
    .DATA_BITS  ( 24 ),
    .DEPTH_BITS ( 4 )
) output_V_data_V_fifo (
    .clk        ( ACLK ),
...
module EdgeDetect_Top_OUTPUT_STREAM_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module EdgeDetect_Top_OUTPUT_STREAM_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
